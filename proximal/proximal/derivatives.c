...
#endif
#include <math.h>
#define __PYX_HAVE__proximal__derivatives
#define __PYX_HAVE_API__proximal__derivatives
#include "pythread.h"
#include "string.h"
#include "stdlib.h"
#include "stdio.h"
...
static int __pyx_f_8proximal_11derivatives_computeRowDerivative_Forward(__Pyx_memviewslice, __Pyx_memviewslice, enum __pyx_t_8proximal_11derivatives_EBoundaryCondition); /*proto*/
static int __pyx_f_8proximal_11derivatives_computeColumnDerivative_Forward(__Pyx_memviewslice, __Pyx_memviewslice, enum __pyx_t_8proximal_11derivatives_EBoundaryCondition); /*proto*/
static int __pyx_f_8proximal_11derivatives_computeRowDerivative_Backward(__Pyx_memviewslice, __Pyx_memviewslice, enum __pyx_t_8proximal_11derivatives_EBoundaryCondition); /*proto*/
static int __pyx_f_8proximal_11derivatives_computeColumnDerivative_Backward(__Pyx_memviewslice, __Pyx_memviewslice, enum __pyx_t_8proximal_11derivatives_EBoundaryCondition); /*proto*/
static int __pyx_f_8proximal_11derivatives_computeDivergence_Forward(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, enum __pyx_t_8proximal_11derivatives_EBoundaryCondition); /*proto*/
static int __pyx_f_8proximal_11derivatives_computeDivergence_Backward(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, enum __pyx_t_8proximal_11derivatives_EBoundaryCondition); /*proto*/
...
#define __Pyx_MODULE_NAME "proximal.derivatives"
int __pyx_module_is_main_proximal__derivatives = 0;

/* Implementation of 'proximal.derivatives' */
...
static int __pyx_f_8proximal_11derivatives_computeRowDerivative_Forward(__Pyx_memviewslice __pyx_v_f, __Pyx_memviewslice __pyx_v_dfdr, enum __pyx_t_8proximal_11derivatives_EBoundaryCondition __pyx_v_ebc) {
  int __pyx_v_nrows;
  int __pyx_v_ncols;
  int __pyx_v_i;
  int __pyx_v_j;
 ...
 *         int i, j
 */
  __pyx_v_nrows = (__pyx_v_f.shape[0]);

  /* "proximal\derivatives.pyx":14
 *     cdef:
 *         int nrows = f.shape[0]
 *         int ncols = f.shape[1]             # <<<<<<<<<<<<<<
 *         int i, j
 ...
 */
  __pyx_v_ncols = (__pyx_v_f.shape[1]);

  /* "proximal\derivatives.pyx":16
 *         int ncols = f.shape[1]
 *         int i, j
 *     for j in range(ncols):             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_t_1 = __pyx_v_ncols;
  for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_1; __pyx_t_2+=1) {
    __pyx_v_j = __pyx_t_2;

    /* "proximal\derivatives.pyx":17
 *         int i, j
 *     for j in range(ncols):
 *         for i in range(nrows-1):             # <<<<<<<<<<<<<<
 *             dfdr[i,j]=f[i+1, j]-f[i, j]
 ...
 */
      ...
      *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_dfdr.data + __pyx_t_9 * __pyx_v_dfdr.strides[0]) ) + __pyx_t_10 * __pyx_v_dfdr.strides[1]) )) = ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_f.data + __pyx_t_5 * __pyx_v_f.strides[0]) ) + __pyx_t_6 * __pyx_v_f.strides[1]) ))) - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_f.data + __pyx_t_7 * __pyx_v_f.strides[0]) ) + __pyx_t_8 * __pyx_v_f.strides[1]) ))));
    }
  }

  /* "proximal\derivatives.pyx":25
 *         for j in range(ncols):
 ...
 */
    case __pyx_e_8proximal_11derivatives_EBC_Circular:

    /* "proximal\derivatives.pyx":20
 *             dfdr[i,j]=f[i+1, j]-f[i, j]
 *     if ebc == EBC_Circular:
 *         for j in range(ncols):             # <<<<<<<<<<<<<<
 *             dfdr[nrows-1, j]=f[0, j]-f[nrows-1, j]
 ...
 */
      ...
      *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_dfdr.data + __pyx_t_13 * __pyx_v_dfdr.strides[0]) ) + __pyx_t_14 * __pyx_v_dfdr.strides[1]) )) = ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_f.data + __pyx_t_11 * __pyx_v_f.strides[0]) ) + __pyx_t_4 * __pyx_v_f.strides[1]) ))) - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_f.data + __pyx_t_3 * __pyx_v_f.strides[0]) ) + __pyx_t_12 * __pyx_v_f.strides[1]) ))));
    }
    break;

    /* "proximal\derivatives.pyx":22
 *         for j in range(ncols):
 *             dfdr[nrows-1, j]=f[0, j]-f[nrows-1, j]
 *     elif ebc == EBC_DirichletZero:             # <<<<<<<<<<<<<<
 *         for j in range(ncols):
 *             dfdr[nrows-1, j]=-f[nrows-1, j]
 */
    case __pyx_e_8proximal_11derivatives_EBC_DirichletZero:

    /* "proximal\derivatives.pyx":23
 *             dfdr[nrows-1, j]=f[0, j]-f[nrows-1, j]
 *     elif ebc == EBC_DirichletZero:
 *         for j in range(ncols):             # <<<<<<<<<<<<<<
 *             dfdr[nrows-1, j]=-f[nrows-1, j]
 ...
 *         for j in range(ncols):
 */
      __pyx_t_15 = (__pyx_v_nrows - 1);
      __pyx_t_16 = __pyx_v_j;
      __pyx_t_17 = (__pyx_v_nrows - 1);
      __pyx_t_18 = __pyx_v_j;
      *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_dfdr.data + __pyx_t_17 * __pyx_v_dfdr.strides[0]) ) + __pyx_t_18 * __pyx_v_dfdr.strides[1]) )) = (-(*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_f.data + __pyx_t_15 * __pyx_v_f.strides[0]) ) + __pyx_t_16 * __pyx_v_f.strides[1]) ))));
    }
    break;
 ...
 *             dfdr[nrows-1, j]=0
 */
    case __pyx_e_8proximal_11derivatives_EBC_VonNeumanZero:

    /* "proximal\derivatives.pyx":26
 *             dfdr[nrows-1, j]=-f[nrows-1, j]
 *     elif ebc == EBC_VonNeumanZero:
 *         for j in range(ncols):             # <<<<<<<<<<<<<<
 *             dfdr[nrows-1, j]=0
 ...
 *         return -1
 */
      __pyx_t_19 = (__pyx_v_nrows - 1);
      __pyx_t_20 = __pyx_v_j;
      *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_dfdr.data + __pyx_t_19 * __pyx_v_dfdr.strides[0]) ) + __pyx_t_20 * __pyx_v_dfdr.strides[1]) )) = 0.0;
    }
    break;
    default:

    /* "proximal\derivatives.pyx":29
 *             dfdr[nrows-1, j]=0
 *     else:
 *         return -1             # <<<<<<<<<<<<<<
 *     return 0
...
static int __pyx_f_8proximal_11derivatives_computeColumnDerivative_Forward(__Pyx_memviewslice __pyx_v_f, __Pyx_memviewslice __pyx_v_dfdc, enum __pyx_t_8proximal_11derivatives_EBoundaryCondition __pyx_v_ebc) {
  int __pyx_v_nrows;
  int __pyx_v_ncols;
  int __pyx_v_i;
  int __pyx_v_j;
 ...
 *     if ebc == EBC_Circular:
 */
    __pyx_t_3 = (__pyx_v_ncols - 1);
    for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
      __pyx_v_j = __pyx_t_4;

      /* "proximal\derivatives.pyx":40
 *     for i in range(nrows):
 *         for j in range(ncols-1):
 *             dfdc[i, j]=f[i, j+1]-f[i, j]             # <<<<<<<<<<<<<<
 *     if ebc == EBC_Circular:
 ...
 */
      ...
      __pyx_t_9 = __pyx_v_i;
      __pyx_t_10 = __pyx_v_j;
      *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_dfdc.data + __pyx_t_9 * __pyx_v_dfdc.strides[0]) ) + __pyx_t_10 * __pyx_v_dfdc.strides[1]) )) = ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_f.data + __pyx_t_5 * __pyx_v_f.strides[0]) ) + __pyx_t_6 * __pyx_v_f.strides[1]) ))) - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_f.data + __pyx_t_7 * __pyx_v_f.strides[0]) ) + __pyx_t_8 * __pyx_v_f.strides[1]) ))));
    }
  }

  /* "proximal\derivatives.pyx":47
 *         for i in range(nrows):
 ...
 */
      ...
      __pyx_t_14 = (__pyx_v_ncols - 1);
      *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_dfdc.data + __pyx_t_13 * __pyx_v_dfdc.strides[0]) ) + __pyx_t_14 * __pyx_v_dfdc.strides[1]) )) = ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_f.data + __pyx_t_4 * __pyx_v_f.strides[0]) ) + __pyx_t_11 * __pyx_v_f.strides[1]) ))) - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_f.data + __pyx_t_12 * __pyx_v_f.strides[0]) ) + __pyx_t_3 * __pyx_v_f.strides[1]) ))));
    }
    break;

    /* "proximal\derivatives.pyx":44
 *         for i in range(nrows):
 *             dfdc[i, ncols-1] = f[i, 0]-f[i, ncols-1]
 *     elif ebc == EBC_DirichletZero:             # <<<<<<<<<<<<<<
 *         for i in range(nrows):
 ...
 */
      ...
      __pyx_t_18 = (__pyx_v_ncols - 1);
      *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_dfdc.data + __pyx_t_17 * __pyx_v_dfdc.strides[0]) ) + __pyx_t_18 * __pyx_v_dfdc.strides[1]) )) = (-(*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_f.data + __pyx_t_15 * __pyx_v_f.strides[0]) ) + __pyx_t_16 * __pyx_v_f.strides[1]) ))));
    }
    break;
 ...
 */
      ...
      __pyx_t_20 = (__pyx_v_ncols - 1);
      *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_dfdc.data + __pyx_t_19 * __pyx_v_dfdc.strides[0]) ) + __pyx_t_20 * __pyx_v_dfdc.strides[1]) )) = 0.0;
    }
    break;
    default:

    /* "proximal\derivatives.pyx":51
 *             dfdc[i, ncols-1]=0
 *     else:
 *         return -1             # <<<<<<<<<<<<<<
 *     return 0
...
static int __pyx_f_8proximal_11derivatives_computeRowDerivative_Backward(__Pyx_memviewslice __pyx_v_f, __Pyx_memviewslice __pyx_v_dfdr, enum __pyx_t_8proximal_11derivatives_EBoundaryCondition __pyx_v_ebc) {
  int __pyx_v_nrows;
  int __pyx_v_ncols;
  int __pyx_v_i;
  int __pyx_v_j;
 ...
 */
      __pyx_t_11 = 0;
      __pyx_t_3 = __pyx_v_j;
      __pyx_t_12 = (__pyx_v_nrows - 1);
      __pyx_t_4 = __pyx_v_j;
      __pyx_t_13 = 0;
      __pyx_t_14 = __pyx_v_j;
      *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_dfdr.data + __pyx_t_13 * __pyx_v_dfdr.strides[0]) ) + __pyx_t_14 * __pyx_v_dfdr.strides[1]) )) = ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_f.data + __pyx_t_11 * __pyx_v_f.strides[0]) ) + __pyx_t_3 * __pyx_v_f.strides[1]) ))) - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_f.data + __pyx_t_12 * __pyx_v_f.strides[0]) ) + __pyx_t_4 * __pyx_v_f.strides[1]) ))));
    }
    break;

    /* "proximal\derivatives.pyx":66
 *         for j in range(ncols):
 *             dfdr[0, j]=f[0, j] - f[nrows-1, j]
 *     elif ebc == EBC_DirichletZero:             # <<<<<<<<<<<<<<
 *         for j in range(ncols):
...
static int __pyx_f_8proximal_11derivatives_computeColumnDerivative_Backward(__Pyx_memviewslice __pyx_v_f, __Pyx_memviewslice __pyx_v_dfdc, enum __pyx_t_8proximal_11derivatives_EBoundaryCondition __pyx_v_ebc) {
  int __pyx_v_nrows;
  int __pyx_v_ncols;
  int __pyx_v_i;
  int __pyx_v_j;
 ...
 *     if ebc == EBC_Circular:
 */
    __pyx_t_3 = __pyx_v_ncols;
    for (__pyx_t_4 = 1; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
      __pyx_v_j = __pyx_t_4;

      /* "proximal\derivatives.pyx":82
 *     for i in range(nrows):
 *         for j in range(1, ncols):
 *             dfdc[i, j]=f[i, j] - f[i, j-1];             # <<<<<<<<<<<<<<
 *     if ebc == EBC_Circular:
 ...
 */
      ...
      __pyx_t_13 = __pyx_v_i;
      __pyx_t_14 = 0;
      *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_dfdc.data + __pyx_t_13 * __pyx_v_dfdc.strides[0]) ) + __pyx_t_14 * __pyx_v_dfdc.strides[1]) )) = ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_f.data + __pyx_t_3 * __pyx_v_f.strides[0]) ) + __pyx_t_11 * __pyx_v_f.strides[1]) ))) - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_f.data + __pyx_t_4 * __pyx_v_f.strides[0]) ) + __pyx_t_12 * __pyx_v_f.strides[1]) ))));
    }
    break;

    /* "proximal\derivatives.pyx":86
 *         for i in range(nrows):
 *             dfdc[i, 0]=f[i, 0] - f[i, ncols-1]
 *     elif ebc == EBC_DirichletZero:             # <<<<<<<<<<<<<<
 *         for i in range(nrows):
...
static int __pyx_f_8proximal_11derivatives_computeGradient(__Pyx_memviewslice __pyx_v_f, __Pyx_memviewslice __pyx_v_dfdr, __Pyx_memviewslice __pyx_v_dfdc, enum __pyx_t_8proximal_11derivatives_EDerivativeType __pyx_v_edt, enum __pyx_t_8proximal_11derivatives_EBoundaryCondition __pyx_v_ebc) {
  int __pyx_v_nrows;
  int __pyx_v_ncols;
  int __pyx_r;
  int __pyx_t_1;
 ...
 */
  ...
  __pyx_L5_next_or:;
  __pyx_t_2 = ((__pyx_v_ncols < 2) != 0);
  __pyx_t_1 = __pyx_t_2;
  __pyx_L4_bool_binop_done:;
  if (__pyx_t_1) {

    /* "proximal\derivatives.pyx":105
 * 
 *     if nrows < 2 or ncols < 2:
 *         return -1             # <<<<<<<<<<<<<<
 * 
 ...
 *         computeColumnDerivative_Forward(f, dfdc, ebc)
 */
    case __pyx_e_8proximal_11derivatives_EDT_Forward:

    /* "proximal\derivatives.pyx":108
 * 
 *     if edt == EDT_Forward:
 *         computeRowDerivative_Forward(f, dfdr, ebc)             # <<<<<<<<<<<<<<
 *         computeColumnDerivative_Forward(f, dfdc, ebc)
 *     elif edt == EDT_Backward:
 */
    __pyx_f_8proximal_11derivatives_computeRowDerivative_Forward(__pyx_v_f, __pyx_v_dfdr, __pyx_v_ebc);

    /* "proximal\derivatives.pyx":109
 *     if edt == EDT_Forward:
 *         computeRowDerivative_Forward(f, dfdr, ebc)
 *         computeColumnDerivative_Forward(f, dfdc, ebc)             # <<<<<<<<<<<<<<
 *     elif edt == EDT_Backward:
 *         computeRowDerivative_Backward(f, dfdr, ebc)
 */
    __pyx_f_8proximal_11derivatives_computeColumnDerivative_Forward(__pyx_v_f, __pyx_v_dfdc, __pyx_v_ebc);
    break;
 ...
 *         computeColumnDerivative_Backward(f, dfdc, ebc)
 */
    case __pyx_e_8proximal_11derivatives_EDT_Backward:

    /* "proximal\derivatives.pyx":111
 *         computeColumnDerivative_Forward(f, dfdc, ebc)
 *     elif edt == EDT_Backward:
 *         computeRowDerivative_Backward(f, dfdr, ebc)             # <<<<<<<<<<<<<<
 *         computeColumnDerivative_Backward(f, dfdc, ebc)
 *     else:
 */
    __pyx_f_8proximal_11derivatives_computeRowDerivative_Backward(__pyx_v_f, __pyx_v_dfdr, __pyx_v_ebc);

    /* "proximal\derivatives.pyx":112
 *     elif edt == EDT_Backward:
 *         computeRowDerivative_Backward(f, dfdr, ebc)
 *         computeColumnDerivative_Backward(f, dfdc, ebc)             # <<<<<<<<<<<<<<
 *     else:
 *         return -1
 */
    __pyx_f_8proximal_11derivatives_computeColumnDerivative_Backward(__pyx_v_f, __pyx_v_dfdc, __pyx_v_ebc);
    break;
    default:

    /* "proximal\derivatives.pyx":114
 *         computeColumnDerivative_Backward(f, dfdc, ebc)
 *     else:
 *         return -1             # <<<<<<<<<<<<<<
 *     return 0
...
static int __pyx_f_8proximal_11derivatives_computeDivergence_Forward(__Pyx_memviewslice __pyx_v_fr, __Pyx_memviewslice __pyx_v_fc, __Pyx_memviewslice __pyx_v_div, enum __pyx_t_8proximal_11derivatives_EBoundaryCondition __pyx_v_ebc) {
  int __pyx_v_nrows;
  int __pyx_v_ncols;
  int __pyx_v_i;
  int __pyx_v_j;
 ...
 *         int i, j
 */
  __pyx_v_nrows = (__pyx_v_fr.shape[0]);

  /* "proximal\derivatives.pyx":122
 *     cdef:
 *         int nrows = fr.shape[0]
 *         int ncols = fr.shape[1]             # <<<<<<<<<<<<<<
 *         int i, j
 *     for i in range(nrows-1):
 */
  __pyx_v_ncols = (__pyx_v_fr.shape[1]);

  /* "proximal\derivatives.pyx":124
 *         int ncols = fr.shape[1]
 *         int i, j
 *     for i in range(nrows-1):             # <<<<<<<<<<<<<<
 *         for j in range(ncols-1):
 ...
 */
      ...
      __pyx_t_13 = __pyx_v_i;
      __pyx_t_14 = __pyx_v_j;
      *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_div.data + __pyx_t_13 * __pyx_v_div.strides[0]) ) + __pyx_t_14 * __pyx_v_div.strides[1]) )) = (((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_fr.data + __pyx_t_5 * __pyx_v_fr.strides[0]) ) + __pyx_t_6 * __pyx_v_fr.strides[1]) ))) - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_fr.data + __pyx_t_7 * __pyx_v_fr.strides[0]) ) + __pyx_t_8 * __pyx_v_fr.strides[1]) )))) + ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_fc.data + __pyx_t_9 * __pyx_v_fc.strides[0]) ) + __pyx_t_10 * __pyx_v_fc.strides[1]) ))) - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_fc.data + __pyx_t_11 * __pyx_v_fc.strides[0]) ) + __pyx_t_12 * __pyx_v_fc.strides[1]) )))));
    }
  }

  /* "proximal\derivatives.pyx":139
 *         for j in range(ncols-1):
 ...
 */
    ...
    __pyx_t_19 = (__pyx_v_nrows - 1);
    __pyx_t_20 = (__pyx_v_ncols - 1);
    __pyx_t_21 = (__pyx_v_nrows - 1);
    __pyx_t_22 = (__pyx_v_ncols - 1);
    *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_div.data + __pyx_t_21 * __pyx_v_div.strides[0]) ) + __pyx_t_22 * __pyx_v_div.strides[1]) )) = (((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_fr.data + __pyx_t_15 * __pyx_v_fr.strides[0]) ) + __pyx_t_1 * __pyx_v_fr.strides[1]) ))) - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_fr.data + __pyx_t_3 * __pyx_v_fr.strides[0]) ) + __pyx_t_16 * __pyx_v_fr.strides[1]) )))) + ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_fc.data + __pyx_t_17 * __pyx_v_fc.strides[0]) ) + __pyx_t_18 * __pyx_v_fc.strides[1]) ))) - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_fc.data + __pyx_t_19 * __pyx_v_fc.strides[0]) ) + __pyx_t_20 * __pyx_v_fc.strides[1]) )))));

    /* "proximal\derivatives.pyx":129
 *     if ebc == EBC_Circular:
 *         div[nrows-1, ncols-1]=(fr[0, ncols-1] - fr[nrows-1, ncols-1]) + (fc[nrows-1, 0] - fc[nrows-1, ncols-1])
 *         for i in range(nrows-1):             # <<<<<<<<<<<<<<
 *             div[i, ncols-1]=(fr[i+1, ncols-1]-fr[i, ncols-1]) + (fc[i, 0] - fc[i, ncols-1])
 *         for j in range(ncols-1):
 */
    __pyx_t_23 = (__pyx_v_nrows - 1);
    for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_23; __pyx_t_2+=1) {
      __pyx_v_i = __pyx_t_2;

      /* "proximal\derivatives.pyx":130
 *         div[nrows-1, ncols-1]=(fr[0, ncols-1] - fr[nrows-1, ncols-1]) + (fc[nrows-1, 0] - fc[nrows-1, ncols-1])
 *         for i in range(nrows-1):
 *             div[i, ncols-1]=(fr[i+1, ncols-1]-fr[i, ncols-1]) + (fc[i, 0] - fc[i, ncols-1])             # <<<<<<<<<<<<<<
 *         for j in range(ncols-1):
 ...
 */
      ...
      __pyx_t_25 = (__pyx_v_ncols - 1);
      __pyx_t_4 = __pyx_v_i;
      __pyx_t_26 = (__pyx_v_ncols - 1);
      __pyx_t_27 = __pyx_v_i;
      __pyx_t_28 = 0;
      __pyx_t_29 = __pyx_v_i;
      __pyx_t_30 = (__pyx_v_ncols - 1);
      __pyx_t_31 = __pyx_v_i;
      __pyx_t_32 = (__pyx_v_ncols - 1);
      *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_div.data + __pyx_t_31 * __pyx_v_div.strides[0]) ) + __pyx_t_32 * __pyx_v_div.strides[1]) )) = (((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_fr.data + __pyx_t_24 * __pyx_v_fr.strides[0]) ) + __pyx_t_25 * __pyx_v_fr.strides[1]) ))) - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_fr.data + __pyx_t_4 * __pyx_v_fr.strides[0]) ) + __pyx_t_26 * __pyx_v_fr.strides[1]) )))) + ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_fc.data + __pyx_t_27 * __pyx_v_fc.strides[0]) ) + __pyx_t_28 * __pyx_v_fc.strides[1]) ))) - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_fc.data + __pyx_t_29 * __pyx_v_fc.strides[0]) ) + __pyx_t_30 * __pyx_v_fc.strides[1]) )))));
    }

    /* "proximal\derivatives.pyx":131
 *         for i in range(nrows-1):
 *             div[i, ncols-1]=(fr[i+1, ncols-1]-fr[i, ncols-1]) + (fc[i, 0] - fc[i, ncols-1])
 *         for j in range(ncols-1):             # <<<<<<<<<<<<<<
 *             div[nrows-1, j]=(fr[0, j]-fr[nrows-1, j]) + (fc[nrows-1, j+1]-fc[nrows-1, j])
 *     elif ebc == EBC_DirichletZero:
 */
    __pyx_t_23 = (__pyx_v_ncols - 1);
    for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_23; __pyx_t_2+=1) {
      __pyx_v_j = __pyx_t_2;

      /* "proximal\derivatives.pyx":132
 *             div[i, ncols-1]=(fr[i+1, ncols-1]-fr[i, ncols-1]) + (fc[i, 0] - fc[i, ncols-1])
 *         for j in range(ncols-1):
 *             div[nrows-1, j]=(fr[0, j]-fr[nrows-1, j]) + (fc[nrows-1, j+1]-fc[nrows-1, j])             # <<<<<<<<<<<<<<
 *     elif ebc == EBC_DirichletZero:
 ...
 */
      ...
      __pyx_t_35 = (__pyx_v_nrows - 1);
      __pyx_t_36 = __pyx_v_j;
      __pyx_t_37 = (__pyx_v_nrows - 1);
      __pyx_t_38 = (__pyx_v_j + 1);
      __pyx_t_39 = (__pyx_v_nrows - 1);
      __pyx_t_40 = __pyx_v_j;
      __pyx_t_41 = (__pyx_v_nrows - 1);
      __pyx_t_42 = __pyx_v_j;
      *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_div.data + __pyx_t_41 * __pyx_v_div.strides[0]) ) + __pyx_t_42 * __pyx_v_div.strides[1]) )) = (((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_fr.data + __pyx_t_33 * __pyx_v_fr.strides[0]) ) + __pyx_t_34 * __pyx_v_fr.strides[1]) ))) - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_fr.data + __pyx_t_35 * __pyx_v_fr.strides[0]) ) + __pyx_t_36 * __pyx_v_fr.strides[1]) )))) + ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_fc.data + __pyx_t_37 * __pyx_v_fc.strides[0]) ) + __pyx_t_38 * __pyx_v_fc.strides[1]) ))) - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_fc.data + __pyx_t_39 * __pyx_v_fc.strides[0]) ) + __pyx_t_40 * __pyx_v_fc.strides[1]) )))));
    }
    break;

    /* "proximal\derivatives.pyx":133
 *         for j in range(ncols-1):
 *             div[nrows-1, j]=(fr[0, j]-fr[nrows-1, j]) + (fc[nrows-1, j+1]-fc[nrows-1, j])
 *     elif ebc == EBC_DirichletZero:             # <<<<<<<<<<<<<<
 *         div[nrows-1, ncols-1]=(-fr[nrows-1, ncols-1]) + (-fc[nrows-1, ncols-1])
 ...
 */
    __pyx_t_23 = (__pyx_v_nrows - 1);
    __pyx_t_43 = (__pyx_v_ncols - 1);
    __pyx_t_44 = (__pyx_v_nrows - 1);
    __pyx_t_45 = (__pyx_v_ncols - 1);
    __pyx_t_46 = (__pyx_v_nrows - 1);
    __pyx_t_47 = (__pyx_v_ncols - 1);
    *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_div.data + __pyx_t_46 * __pyx_v_div.strides[0]) ) + __pyx_t_47 * __pyx_v_div.strides[1]) )) = ((-(*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_fr.data + __pyx_t_23 * __pyx_v_fr.strides[0]) ) + __pyx_t_43 * __pyx_v_fr.strides[1]) )))) + (-(*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_fc.data + __pyx_t_44 * __pyx_v_fc.strides[0]) ) + __pyx_t_45 * __pyx_v_fc.strides[1]) )))));

    /* "proximal\derivatives.pyx":135
 *     elif ebc == EBC_DirichletZero:
 *         div[nrows-1, ncols-1]=(-fr[nrows-1, ncols-1]) + (-fc[nrows-1, ncols-1])
 *         for i in range(nrows-1):             # <<<<<<<<<<<<<<
 *             div[i, ncols-1]=(fr[i+1, ncols-1]-fr[i, ncols-1]) + (-fc[i, ncols-1])
 *         for j in range(ncols-1):
 */
    __pyx_t_48 = (__pyx_v_nrows - 1);
    for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_48; __pyx_t_2+=1) {
      __pyx_v_i = __pyx_t_2;

      /* "proximal\derivatives.pyx":136
 *         div[nrows-1, ncols-1]=(-fr[nrows-1, ncols-1]) + (-fc[nrows-1, ncols-1])
 *         for i in range(nrows-1):
 *             div[i, ncols-1]=(fr[i+1, ncols-1]-fr[i, ncols-1]) + (-fc[i, ncols-1])             # <<<<<<<<<<<<<<
 *         for j in range(ncols-1):
 ...
 */
      ...
      __pyx_t_50 = (__pyx_v_ncols - 1);
      __pyx_t_51 = __pyx_v_i;
      __pyx_t_52 = (__pyx_v_ncols - 1);
      __pyx_t_53 = __pyx_v_i;
      __pyx_t_54 = (__pyx_v_ncols - 1);
      __pyx_t_55 = __pyx_v_i;
      __pyx_t_56 = (__pyx_v_ncols - 1);
      *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_div.data + __pyx_t_55 * __pyx_v_div.strides[0]) ) + __pyx_t_56 * __pyx_v_div.strides[1]) )) = (((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_fr.data + __pyx_t_49 * __pyx_v_fr.strides[0]) ) + __pyx_t_50 * __pyx_v_fr.strides[1]) ))) - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_fr.data + __pyx_t_51 * __pyx_v_fr.strides[0]) ) + __pyx_t_52 * __pyx_v_fr.strides[1]) )))) + (-(*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_fc.data + __pyx_t_53 * __pyx_v_fc.strides[0]) ) + __pyx_t_54 * __pyx_v_fc.strides[1]) )))));
    }

    /* "proximal\derivatives.pyx":137
 *         for i in range(nrows-1):
 *             div[i, ncols-1]=(fr[i+1, ncols-1]-fr[i, ncols-1]) + (-fc[i, ncols-1])
 *         for j in range(ncols-1):             # <<<<<<<<<<<<<<
 *             div[nrows-1, j]=(-fr[nrows-1, j]) + (fc[nrows-1, j+1]-fc[nrows-1, j])
 *     elif ebc == EBC_VonNeumanZero:
 */
    __pyx_t_48 = (__pyx_v_ncols - 1);
    for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_48; __pyx_t_2+=1) {
      __pyx_v_j = __pyx_t_2;

      /* "proximal\derivatives.pyx":138
 *             div[i, ncols-1]=(fr[i+1, ncols-1]-fr[i, ncols-1]) + (-fc[i, ncols-1])
 *         for j in range(ncols-1):
 *             div[nrows-1, j]=(-fr[nrows-1, j]) + (fc[nrows-1, j+1]-fc[nrows-1, j])             # <<<<<<<<<<<<<<
 *     elif ebc == EBC_VonNeumanZero:
 *         div[nrows-1, ncols-1] = 0
 */
      __pyx_t_57 = (__pyx_v_nrows - 1);
      __pyx_t_58 = __pyx_v_j;
      __pyx_t_59 = (__pyx_v_nrows - 1);
      __pyx_t_60 = (__pyx_v_j + 1);
      __pyx_t_61 = (__pyx_v_nrows - 1);
      __pyx_t_62 = __pyx_v_j;
      __pyx_t_63 = (__pyx_v_nrows - 1);
      __pyx_t_64 = __pyx_v_j;
      *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_div.data + __pyx_t_63 * __pyx_v_div.strides[0]) ) + __pyx_t_64 * __pyx_v_div.strides[1]) )) = ((-(*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_fr.data + __pyx_t_57 * __pyx_v_fr.strides[0]) ) + __pyx_t_58 * __pyx_v_fr.strides[1]) )))) + ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_fc.data + __pyx_t_59 * __pyx_v_fc.strides[0]) ) + __pyx_t_60 * __pyx_v_fc.strides[1]) ))) - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_fc.data + __pyx_t_61 * __pyx_v_fc.strides[0]) ) + __pyx_t_62 * __pyx_v_fc.strides[1]) )))));
    }
    break;
 ...
 */
    __pyx_t_48 = (__pyx_v_nrows - 1);
    __pyx_t_65 = (__pyx_v_ncols - 1);
    *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_div.data + __pyx_t_48 * __pyx_v_div.strides[0]) ) + __pyx_t_65 * __pyx_v_div.strides[1]) )) = 0.0;

    /* "proximal\derivatives.pyx":141
 *     elif ebc == EBC_VonNeumanZero:
 *         div[nrows-1, ncols-1] = 0
 *         for i in range(nrows-1):             # <<<<<<<<<<<<<<
 *             div[i, ncols-1]=(fr[i+1, ncols-1]-fr[i, ncols-1])
 *         for j in range(ncols-1):
 */
    __pyx_t_66 = (__pyx_v_nrows - 1);
    for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_66; __pyx_t_2+=1) {
      __pyx_v_i = __pyx_t_2;

      /* "proximal\derivatives.pyx":142
 *         div[nrows-1, ncols-1] = 0
 *         for i in range(nrows-1):
 *             div[i, ncols-1]=(fr[i+1, ncols-1]-fr[i, ncols-1])             # <<<<<<<<<<<<<<
 *         for j in range(ncols-1):
 ...
 */
      ...
      __pyx_t_68 = (__pyx_v_ncols - 1);
      __pyx_t_69 = __pyx_v_i;
      __pyx_t_70 = (__pyx_v_ncols - 1);
      __pyx_t_71 = __pyx_v_i;
      __pyx_t_72 = (__pyx_v_ncols - 1);
      *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_div.data + __pyx_t_71 * __pyx_v_div.strides[0]) ) + __pyx_t_72 * __pyx_v_div.strides[1]) )) = ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_fr.data + __pyx_t_67 * __pyx_v_fr.strides[0]) ) + __pyx_t_68 * __pyx_v_fr.strides[1]) ))) - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_fr.data + __pyx_t_69 * __pyx_v_fr.strides[0]) ) + __pyx_t_70 * __pyx_v_fr.strides[1]) ))));
    }

    /* "proximal\derivatives.pyx":143
 *         for i in range(nrows-1):
 *             div[i, ncols-1]=(fr[i+1, ncols-1]-fr[i, ncols-1])
 *         for j in range(ncols-1):             # <<<<<<<<<<<<<<
 *             div[nrows-1, j] = (fc[nrows-1, j+1]-fc[nrows-1, j])
 *     else:
 */
    __pyx_t_66 = (__pyx_v_ncols - 1);
    for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_66; __pyx_t_2+=1) {
      __pyx_v_j = __pyx_t_2;

      /* "proximal\derivatives.pyx":144
 *             div[i, ncols-1]=(fr[i+1, ncols-1]-fr[i, ncols-1])
 *         for j in range(ncols-1):
 *             div[nrows-1, j] = (fc[nrows-1, j+1]-fc[nrows-1, j])             # <<<<<<<<<<<<<<
 *     else:
 *         return -1
 */
      __pyx_t_73 = (__pyx_v_nrows - 1);
      __pyx_t_74 = (__pyx_v_j + 1);
      __pyx_t_75 = (__pyx_v_nrows - 1);
      __pyx_t_76 = __pyx_v_j;
      __pyx_t_77 = (__pyx_v_nrows - 1);
      __pyx_t_78 = __pyx_v_j;
      *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_div.data + __pyx_t_77 * __pyx_v_div.strides[0]) ) + __pyx_t_78 * __pyx_v_div.strides[1]) )) = ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_fc.data + __pyx_t_73 * __pyx_v_fc.strides[0]) ) + __pyx_t_74 * __pyx_v_fc.strides[1]) ))) - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_fc.data + __pyx_t_75 * __pyx_v_fc.strides[0]) ) + __pyx_t_76 * __pyx_v_fc.strides[1]) ))));
    }
    break;
    default:

    /* "proximal\derivatives.pyx":146
 *             div[nrows-1, j] = (fc[nrows-1, j+1]-fc[nrows-1, j])
 *     else:
 *         return -1             # <<<<<<<<<<<<<<
 *     return 0
...
static int __pyx_f_8proximal_11derivatives_computeDivergence_Backward(__Pyx_memviewslice __pyx_v_fr, __Pyx_memviewslice __pyx_v_fc, __Pyx_memviewslice __pyx_v_div, enum __pyx_t_8proximal_11derivatives_EBoundaryCondition __pyx_v_ebc) {
  int __pyx_v_nrows;
  int __pyx_v_ncols;
  int __pyx_v_i;
  int __pyx_v_j;
 ...
 */
    ...
    __pyx_t_23 = 0;
    __pyx_t_24 = 0;
    *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_div.data + __pyx_t_23 * __pyx_v_div.strides[0]) ) + __pyx_t_24 * __pyx_v_div.strides[1]) )) = (((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_fr.data + __pyx_t_15 * __pyx_v_fr.strides[0]) ) + __pyx_t_16 * __pyx_v_fr.strides[1]) ))) - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_fr.data + __pyx_t_17 * __pyx_v_fr.strides[0]) ) + __pyx_t_18 * __pyx_v_fr.strides[1]) )))) + ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_fc.data + __pyx_t_19 * __pyx_v_fc.strides[0]) ) + __pyx_t_20 * __pyx_v_fc.strides[1]) ))) - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_fc.data + __pyx_t_21 * __pyx_v_fc.strides[0]) ) + __pyx_t_22 * __pyx_v_fc.strides[1]) )))));

    /* "proximal\derivatives.pyx":161
 *     if ebc == EBC_Circular:
 *         div[0, 0] = (fr[0, 0] - fr[nrows-1, 0]) + (fc[0,0] - fc[0, ncols-1])
 *         for i in range(1, nrows):             # <<<<<<<<<<<<<<
 *             div[i, 0] = (fr[i, 0] - fr[i-1, 0]) + (fc[i, 0] - fc[i, ncols-1])
 ...
 */
      ...
      __pyx_t_31 = __pyx_v_i;
      __pyx_t_32 = 0;
      *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_div.data + __pyx_t_31 * __pyx_v_div.strides[0]) ) + __pyx_t_32 * __pyx_v_div.strides[1]) )) = (((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_fr.data + __pyx_t_3 * __pyx_v_fr.strides[0]) ) + __pyx_t_25 * __pyx_v_fr.strides[1]) ))) - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_fr.data + __pyx_t_26 * __pyx_v_fr.strides[0]) ) + __pyx_t_27 * __pyx_v_fr.strides[1]) )))) + ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_fc.data + __pyx_t_4 * __pyx_v_fc.strides[0]) ) + __pyx_t_28 * __pyx_v_fc.strides[1]) ))) - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_fc.data + __pyx_t_29 * __pyx_v_fc.strides[0]) ) + __pyx_t_30 * __pyx_v_fc.strides[1]) )))));
    }

    /* "proximal\derivatives.pyx":163
 *         for i in range(1, nrows):
 *             div[i, 0] = (fr[i, 0] - fr[i-1, 0]) + (fc[i, 0] - fc[i, ncols-1])
 *         for j in range(1, ncols):             # <<<<<<<<<<<<<<
 *             div[0, j] = (fr[0, j] - fr[nrows-1, j]) + (fc[0, j] - fc[0, j-1])
 ...
 */
    ...
    __pyx_t_47 = 0;
    __pyx_t_48 = 0;
    *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_div.data + __pyx_t_47 * __pyx_v_div.strides[0]) ) + __pyx_t_48 * __pyx_v_div.strides[1]) )) = ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_fr.data + __pyx_t_43 * __pyx_v_fr.strides[0]) ) + __pyx_t_44 * __pyx_v_fr.strides[1]) ))) + (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_fc.data + __pyx_t_45 * __pyx_v_fc.strides[0]) ) + __pyx_t_46 * __pyx_v_fc.strides[1]) ))));

    /* "proximal\derivatives.pyx":167
 *     elif ebc == EBC_DirichletZero:
 *         div[0, 0]=fr[0, 0] + fc[0, 0]
 *         for i in range(1, nrows):             # <<<<<<<<<<<<<<
 *             div[i, 0] = (fr[i, 0] - fr[i-1, 0]) + fc[i, 0]
 ...
 */
    __pyx_t_65 = 0;
    __pyx_t_66 = 0;
    *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_div.data + __pyx_t_65 * __pyx_v_div.strides[0]) ) + __pyx_t_66 * __pyx_v_div.strides[1]) )) = 0.0;

    /* "proximal\derivatives.pyx":173
 *     elif ebc == EBC_VonNeumanZero:
 *         div[0, 0]=0
 *         for i in range(1, nrows):             # <<<<<<<<<<<<<<
 *             div[i, 0]=(fr[i, 0] - fr[i-1, 0])
...
static int __pyx_f_8proximal_11derivatives_computeDivergence(__Pyx_memviewslice __pyx_v_fr, __Pyx_memviewslice __pyx_v_fc, __Pyx_memviewslice __pyx_v_div, enum __pyx_t_8proximal_11derivatives_EDerivativeType __pyx_v_edt, enum __pyx_t_8proximal_11derivatives_EBoundaryCondition __pyx_v_ebc) {
  int __pyx_v_nrows;
  int __pyx_v_ncols;
  int __pyx_r;
  int __pyx_t_1;
 ...
 *         computeDivergence_Backward(fr, fc, div, ebc)
 */
    __pyx_f_8proximal_11derivatives_computeDivergence_Forward(__pyx_v_fr, __pyx_v_fc, __pyx_v_div, __pyx_v_ebc);
    break;
 ...
 *         return -1
 */
    __pyx_f_8proximal_11derivatives_computeDivergence_Backward(__pyx_v_fr, __pyx_v_fc, __pyx_v_div, __pyx_v_ebc);
    break;
    default:

    /* "proximal\derivatives.pyx":195
 *         computeDivergence_Backward(fr, fc, div, ebc)
 *     else:
 *         return -1             # <<<<<<<<<<<<<<
 *     return 0
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "proximal.derivatives.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "proximal.derivatives.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "proximal.derivatives.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "proximal.derivatives._memoryviewslice", /*tp_name*/
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initderivatives(void); /*proto*/
PyMODINIT_FUNC initderivatives(void)
#else
PyMODINIT_FUNC PyInit_derivatives(void); /*proto*/
PyMODINIT_FUNC PyInit_derivatives(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_derivatives(void)", 0);
  ...
  #endif
  if (__pyx_module_is_main_proximal__derivatives) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    if (!PyDict_GetItemString(modules, "proximal.derivatives")) {
      if (unlikely(PyDict_SetItemString(modules, "proximal.derivatives", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  if (__Pyx_ExportFunction("computeGradient", (void (*)(void))__pyx_f_8proximal_11derivatives_computeGradient, "int (__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, enum __pyx_t_8proximal_11derivatives_EDerivativeType, enum __pyx_t_8proximal_11derivatives_EBoundaryCondition)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ExportFunction("computeDivergence", (void (*)(void))__pyx_f_8proximal_11derivatives_computeDivergence, "int (__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, enum __pyx_t_8proximal_11derivatives_EDerivativeType, enum __pyx_t_8proximal_11derivatives_EBoundaryCondition)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  /*--- Type init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init proximal.derivatives", __pyx_clineno, __pyx_lineno, __pyx_filename);
      Py_DECREF(__pyx_d); __pyx_d = 0;
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init proximal.derivatives");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
